...
fare la riassegnazione del valore if gende = n/a riassegnazione del valore altrimenti niente.
  */
...
for (let i = 0; i < femaleCharacters.length; i++) {
  let femaleNames = femaleCharacters[i].name; 
  let index = charactersNames.indexOf(femaleNames);
  if (index !== -1) {
  charactersNames.splice(index, 1);
}
}

console.log ('Lunghezza dopo la rimozione', charactersNames.length)

/*https://stackoverflow.com/questions/40031165/remove-elements-of-an-array-from-another-array-using-javascript and https://it.javascript.info/array-methods
